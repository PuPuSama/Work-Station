...
ServerTaskAuditAction = Literal[
    ...
    "article.task.completion.updated",
...
SERVER_TASK_ACTION_PERMISSIONS: dict[
    ...
    "article.task.completion.updated": "article.edit",
    ...
    "article.generation.checked": "article.edit",
...
SERVER_TASK_ACTION_DETAIL_KEYS: dict[
    ...
    "article.task.completion.updated": frozenset({"completed"}),
    ...
    "article.generation.checked": frozenset({"ai_score_recorded", "knowledge_coverage_status"}),
