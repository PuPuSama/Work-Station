...
class ServerRequestSecurityTests(unittest.TestCase):
    ...
    def test_unmigrated_server_routes_fail_closed(self) -> None:
        ...
        self.assertTrue(
            server_http_route_available(
                "PUT",
                "/api/projects/example.com/tasks/task-a/seo-reviews/"
                "review-a/changes/change-a",
            )
        )
        for action in ("apply", "complete", "preview"):
            self.assertTrue(
                server_http_route_available(
                    "POST",
                    "/api/projects/example.com/tasks/task-a/"
                    f"seo-reviews/review-a/{action}",
                )
            )
        self.assertTrue(
            server_http_route_available(
        ...
        self.assertTrue(
            server_http_route_available(
                "POST",
                "/api/organizations/org-a/users/user-a/sessions/revoke",
            )
        )
        self.assertFalse(
            server_http_route_available(
        ...
        self.assertFalse(
            server_http_route_available(
                "GET",
                "/api/projects/project-a/members/other",
            )
        )
        self.assertTrue(
            server_http_route_available(
        ...
        self.assertTrue(
            server_http_route_available(
                "POST",
                "/api/projects/project-a/tasks/task-a/humanize",
            )
        )
        self.assertTrue(
            server_http_route_available(
        ...
        self.assertTrue(
            server_http_route_available(
                "PUT",
                "/api/projects/project-a/tasks/task-a/checks/initial-ai",
            )
        )
        self.assertTrue(
            server_http_route_available(
        ...
        self.assertTrue(
            server_http_route_available(
                "GET",
                "/api/projects/project-a/tasks/task-a/checks/"
                "initial-ai/screenshot/download",
            )
        )
        self.assertFalse(
            server_http_route_available(
        ...
        self.assertTrue(
            server_http_route_available(
                "POST",
                "/api/projects/example.com/task-imports",
            )
        )
        self.assertFalse(
            server_http_route_available(
        ...
        self.assertFalse(
            server_http_route_available(
                "POST",
                "/api/projects/example.com/task-imports/import-a",
            )
        )
        self.assertTrue(
            server_http_route_available(
        ...
        self.assertTrue(
            server_http_route_available(
                "PUT",
                "/api/projects/example.com/tasks/task-a/selected-title",
            )
        )
        self.assertTrue(
            server_http_route_available(
                "PUT",
                "/api/projects/example.com/tasks/task-a/manual-completion",
            )
        )
        self.assertTrue(
            server_http_route_available(
        ...
        self.assertTrue(
            server_http_route_available(
                "POST",
                "/api/projects/example.com/tasks/task-a/titles",
            )
        )
        self.assertTrue(
            server_http_route_available(
        ...
        self.assertTrue(
            server_http_route_available(
                "POST",
                "/api/projects/example.com/tasks/task-a/article",
            )
        )
        self.assertTrue(
            server_http_route_available(
        ...
        self.assertTrue(
            server_http_route_available(
                "POST",
                "/api/projects/example.com/tasks/task-a/article/rewrite",
            )
        )
        self.assertTrue(
            server_http_route_available(
                "GET",
                "/api/projects/example.com/tasks/task-a/"
                "article/rewrite/jobs/job-a",
            )
        )
        self.assertTrue(
            server_http_route_available(
                "POST",
                "/api/projects/example.com/tasks/task-a/restore-links",
            )
        )
        self.assertTrue(
            server_http_route_available(
