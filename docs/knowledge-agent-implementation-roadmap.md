...
- 已接通两个 PostgreSQL-only Task 写操作：“完全重写”和“从正式目录选择已确认产品”；
  二者都要求 `article.edit`、Project Scope 与 Revision CAS，且不创建本地
  JSON/SQLite/Artifact；产品接口只接收 Product ID，并只投影 Published Current
  Snapshot 证据，其他写路径仍关闭；
